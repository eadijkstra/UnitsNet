    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(ElectricConductivityUnit), (int)ElectricConductivityUnit.MicrosiemensPerCentimeter, new string[]{"µS/cm"}),
                ("en-US", typeof(ElectricConductivityUnit), (int)ElectricConductivityUnit.MillisiemensPerCentimeter, new string[]{"mS/cm"}),
                ("en-US", typeof(ElectricConductivityUnit), (int)ElectricConductivityUnit.SiemensPerCentimeter, new string[]{"S/cm"}),
